# 🍫 Global Chocolate Sales Analysis – Power BI Project
...
- Creation of a Date Table using DAX
- Data modeling and relationship management
- KPI development using DAX measures
...
Provides detailed performance metrics for each salesperson:
- Total Sales
- Average Revenue per Box
- Boxes Shipped
